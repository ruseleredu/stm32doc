...
Veja a documentação do [STM32F4xx HAL Driver](https://ruseleredu.github.io/stm32f4xx-hal-driver-doxygen/index.html) para mais detalhes sobre as funções de GPIO e Delay.
